...
const App = () => {
    ...
    return (
        ...
        >
            ...
            <i className={styles.slogan}>Effortless Expense Management – Track, Submit, and Save!</i>
            <Card
                style={{
                    width: 450,
                    ...
                    <Form.Item
                        ...
                        rules={[
                            ...
                            },
                            {
                                ...
                                message:
                                    "Name must contain at least one letter and can only contain letters and spaces",
                            },
                        ]}
                    >
                        <Input
